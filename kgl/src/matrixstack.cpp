...
MatrixStack* MatrixStack::gInstance = 0;

// Singleton implementation
// use this function to get the instance of MatrixStack
MatrixStack*
MatrixStack::instance (void) {

    if (0 != gInstance)
	    return gInstance;
    else
	    gInstance = new MatrixStack();
...
#ifdef MatrixStack_ALWAYS_SEND_TO_OPENGL
    matrixToGL(aType);
#endif
...
float *
MatrixStack::get(MatrixTypes aType)
{
...
// universal
void
MatrixStack::matrixToGL(MatrixTypes aType)
{
    if (mInit) {
...
void
MatrixStack::setIdentityMatrix( float *mat, int size) {
...
// res = a cross b;
void
MatrixStack::crossProduct( float *a, float *b, float *res) {
